...
class TimeButton extends StatelessWidget {
  ...
  const TimeButton({Key? key,required this.onTap,required this.time,this.iconColor}) : super(key: key);
      ...
      child: InkWell(
        ...
        child: Row(
          ...
          children: [
            ...
            AppText(title: '${'Time'.tr()} ${time!=null?CalenderManager.getTimeName(time: time!):''}',
             ...
             Icon(Icons.keyboard_arrow_down_sharp,color:iconColor?? ColorManager.primary,size: AppSize.s25,),
