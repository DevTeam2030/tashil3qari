...
class AppScaffold extends StatelessWidget {
  ...
  const AppScaffold({super.key,required this.content,this.showBackIcon=true,this.padding});
                ...
                InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.arrow_back_ios_rounded,color: ColorManager.white,size: AppSize.s14),
                      AppSizeBox(width: AppSize.s8.w,),
                      AppText(title:'back'.tr(),
                        titleColor:ColorManager.white ,titleMaxLines: 1, titleSize:FontSize.s14,),
                    ],
                  ),
                ),
