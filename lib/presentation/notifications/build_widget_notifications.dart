...
class BuildWidgetNotifications extends StatefulWidget {
 ...
 final List<NotificationModel> notifications;
  const BuildWidgetNotifications({Key? key,required this.notifications,required this.isUser}) : super(key: key);

  @override
  State<BuildWidgetNotifications> createState() => _BuildWidgetNotificationsState();
}

class _BuildWidgetNotificationsState extends State<BuildWidgetNotifications> {
...
@override
  ...
  var date=DateTime.now();
    todayList=widget.notifications.where((element) => element.date.year==date.year&&
        ...
        slivers: [
          ...
          SliverList(
              delegate: SliverChildBuilderDelegate(
                  ...
                  return widget.isUser?UserNotificationItem(isRead:true, notification: todayList[index]):
                  ConsultantNotificationItem(isRead:true, notification: todayList[index]);
                },
          ...
          SliverList(
              delegate: SliverChildBuilderDelegate(
                    (BuildContext context, int index) {
                      return widget.isUser?UserNotificationItem(isRead:true, notification: previousList[index]):
                      ConsultantNotificationItem(isRead:true, notification: previousList[index]);
                },
