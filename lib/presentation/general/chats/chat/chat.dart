...
// import 'package:tashil_agary/providers/agreements_provider.dart';
...
//   const ChatScreen({Key? key,required this.receiverId,required this.receiverName,required this.receiverImage,
//     required this.receiverType,required this.propertyId,this.isOpportunity=false}) : super(key: key);
//
//   @override
...
//     super.initState();
//
//     if(mounted&&widget.propertyId!=null)context.read<ChatProvider>().updatePropertyIdInAllMessages(
...
//             builder: (context, agreementProvider, child) =>Consumer<ChatProvider>(
//                 builder: (context, provider, child) =>ScreenLoading(
//                   isLoading: provider.isLoading||agreementProvider.isLoading,
//                   child: Container(
//                     height: 1.0.sh,
//                     width: 1.0.sw,
...
//                                     itemBuilder: (_,index){
//                                       if(snapshot.data!.docs[index]==snapshot.data!.docs.last){
...
//                                       }
//
//                                       return MessageChatItem(document: snapshot.data!.docs[index],
//                                       isOpportunity: widget.isOpportunity,
