...
class ForSaleOrRentDropdownButton extends StatefulWidget {
  ...
  final String hint;
  final ValueNotifier<bool> monthly;
  final bool inAppbar;
const ForSaleOrRentDropdownButton({Key? key,required this.onChanged,required this.hint,
  this.width,required this.selectedType,this.color,this.borderColor,this.inAppbar=false,
required this.monthly,}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if(!widget.inAppbar&&selectedType==AdType.forRent)
        SwitchItem(
          padding: EdgeInsets.zero,
          notifier:widget.monthly, title: 'contract duration'.tr(),
          addTitleIfTrue: '(${'Monthly'.tr()})',addTitleIFFalse:  '(${'Annual'.tr()})', ),
      ],
    );
